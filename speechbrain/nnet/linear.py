...
class Linear2(torch.nn.Module):
    ...
    def __init__(
        ...
        # Weights are initialized following pytorch approach
        self.h = nn.Linear(input_size, n_hid, bias=bias)
        self.w = nn.Linear(n_hid, n_neurons, bias=bias)
...
class Linear3(torch.nn.Module): #for LSTM/GRU which return hidden states
    """Computes a linear transformation y = wx + b.
